  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <BodyContent className="flex-grow">
        <section
          className={`pt-24 pb-24 mt-4 px-4 sm:px-6 lg:px-8 text-center transition-all duration-1000 ${
        ...
        >
          ...
          <div className="marginnnn mt-16">
          {/* Subtitle */}
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-2">
            Blog articles publishing soon! 🚀
          </p>

          {/* LinkedIn Info */}
          <p className="text-md md:text-lg text-gray-600 max-w-2xl mx-auto mb-12">
            Until then, visit my{" "}
            <a
              href="https://www.linkedin.com/in/mihilayan-sachinthana"
              target="_blank"
            ...
            to read my latest blogs and insights.
          </p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center mt-28">
            <div className="relative w-16 h-16 flex items-center justify-center">
              {/* Outer pulsing ring */}
              <div className="absolute w-full h-full rounded-full border-4 border-blue-950 opacity-30 animate-ping"></div>

              {/* Inner glowing dot */}
              <div className="w-6 h-6 bg-blue-950 rounded-full animate-pulse"></div>
            </div>

            <p className="mt-6 text-gray-500 animate-fadeInSlow">
